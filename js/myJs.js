const textConfig = {
    ...
    text4: "Nếu em ko trả lời mà thoát ra thì em là con cún :))) :v",
    text5: "Anh mơ à???",
    text6: "Yêu ơi là yêu <3",
    text7: "lí do gì em thích anh nhở?? :vvvv",
    text8: "Gửi cho anh <3",
    text9: "Vì a đẹp try vlllll =))))))))))))))))))))))))))))))))))))))))))))))",
    text10: "A biết mà ^^ Yêu e 300.000",
    text11: "Đùa thế chứ giờ thì chờ gì nữa mà ko inbox lí do cho anh đi nàooo",
    text12: "Okii lunn <3",
};
